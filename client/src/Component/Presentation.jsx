  ...
  return (
    <div className='presention sup1400:py-[150px] sup968:py-[120px] w-full bg-belge py-[80px] my-0 mx-auto'>
      <div className='sup1400:mt-[150px] sup968:mt-[120px] sup750:flex sup750:flex-row-reverse sup750:justify-between sup750:items-start mt-[80px] w-[80%]  mx-auto border-l-[5px] border-l-jaune pl-[20px] max-w-[1400px]'>
        ...
        <div >
            <p className='sup1400:pb-[15px] sup1400:text-[70px] sup968:pb-[12px] sup968:text-[50px] text-[30px] font-black pb-[7px] '>Péria Aurélien</p>
            <p className='sup1400:pb-[10px]  sup1400:text-[35px] sup968:pb-[7px] sup968:text-[30px]  text-[20px] font-bold pb-[5px] ' >Front-end Developer</p>
            <p className='sup1400:pb-[10px]  sup1400:text-[25px] sup968:pb-[7px] sup968:text-[20px]  text-[12px] pb-[5px] '>I am looking for professional experience</p>
            <div className='sup1400:text-[25px] sup968:flex-row sup968:text-[20px] text-[12px]  flex flex-col'>
              ...
              <ParaPresentation src={voiture} alt={"Logo voiture"} texte={"Open to mobility"} />
            </div>
        </div>
      </div>
    </div>
