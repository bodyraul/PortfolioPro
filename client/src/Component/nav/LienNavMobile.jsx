...
import github from '../../Asset/Img/guitBelge.png'
import mail from '../../Asset/Img/mailBelge.png'
import linkedin from '../../Asset/Img/linkedinBelge.png'

export default function LienNavMobile() {
  return (
    <p className='w-[100%] flex justify-around'>
        ...
        <a target="blank"  href="https://github.com/Aurelien-Peria">
