...
export default function Project() {
  return (
    <div   className='projet bg-belge  '>
        <Titre boolean="true" color="text-noir" contenu="Project"></Titre>
        <div  className='sup1400:gap-32 sup968:gap-10 sup968:grid-cols-[repeat(3,1fr)] w-[80%] grid grid-rows-[repeat(3,1fr)] grid-cols-[repeat(1,1fr)] my-0 mx-auto max-w-[1400px] pb-[150px] '>
